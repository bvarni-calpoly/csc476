...
#define IM_RGB(r, g, b) IM_COL32(r, g, b, 255)
    ...
    ImVec4 GetAutoColor(ImPlot3DCol idx)
    {
        ...
        case ImPlot3DCol_AxisGrid:
            return ImGui::GetStyleColorVec4(ImGuiCol_Text) * ImVec4(1, 1, 1, 0.25f);
        case ImPlot3DCol_AxisTick:
            return GetStyleColorVec4(ImPlot3DCol_AxisGrid);
        case ImPlot3DCol_AxisBg:
            return ImVec4(0, 0, 0, 0);
        case ImPlot3DCol_AxisBgHovered:
            return ImGui::GetStyleColorVec4(ImGuiCol_ButtonHovered);
        case ImPlot3DCol_AxisBgActive:
